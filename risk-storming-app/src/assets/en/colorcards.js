export const colorcards = {
         ...
         'green-25': {
           ...
           exampleThree:
             'Keep them small, clean, and most importantly: valuable.',
         },
         'orange-1': {
           id: 'orange-1',
           color: 'orange',
         ...
         'orange-22': {
           ...
           exampleTwo:
             'Split by technology: UI, database, calculation logic,...',
           exampleThree:
         ...
         'pink-12': {
           ...
           exampleTwo:
             'The name field should never take more than 50 characters. ',
         ...
         'pink-21': {
           ...
           exampleOne:
             'Use the company’s own product in real world situations.',
           exampleTwo:
